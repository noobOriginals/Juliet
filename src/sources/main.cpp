...
int main() {
    ...
    core::addObjectToScene(core::makeQuad(vec3(2.0f, 0.5f, -2.0f), vec3(2.0f, 0.0f, 2.0f), vec3(0.0f, -2.0f, 0.0f), 3), scn);
    core::addObjectToScene(core::makeQuad(vec3(-2.0f, 0.5f, -2.0f), vec3(2.0f, 0.0f, -2.0f), vec3(0.0f, -2.0f, 0.0f), 3), scn);
    core::addObjectToScene(core::makeQuad(vec3(0.0f, 0.5f, -3.0f), vec3(2.0f, 0.0f, 0.0f), vec3(0.0f, -2.0f, 0.0f), 3), scn);
    ...
    core::addMaterialToScene(core::makeDielectric(vec3(0.467, 0.871, 1), 1.5f), scn);
    ...
    renderParameters.cameraPos = vec3(-3.0f, 3.5f, 8.0f);
